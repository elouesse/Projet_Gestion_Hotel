...
<f:form modelAttribute="modelHotel" action="addHotel" method="POST">
		<table>
		<!-- 	<tr>
				<th>Nom</th>
				<th>Adresse</th>
			...
			<tr>
				<td>Nom :</td>
				<td><f:input type ="text" path="nomHotel" class="form-control"/></td>
				<td><f:errors path="nomHotel"></f:errors></td>
			</tr>
			<tr>
				<td>Adresse :</td>
				<td><f:input type ="text" path="adrHotel" class="form-control"/></td>
				<td><f:errors path="adrHotel"></f:errors></td>
			</tr>
			<tr>
				<td>Classe :</td>
				<td><f:input type ="text" path="classeHotel" class="form-control"/></td>
				<td><f:errors path="classeHotel"></f:errors></td>
			</tr>
			<tr>
				<td>Pays :</td>
				<td><f:input type ="text" path="pays" class="form-control"/></td>
				<td><f:errors path="pays"></f:errors></td>
			</tr>
			<tr>
				<td>Code Postale :</td>
				<td><f:input type ="text" path="codePostal" class="form-control"/></td>
				<td><f:errors path="codePostal"></f:errors></td>
			</tr>
			<tr>
				<td>Numémro téléphone :</td>
				<td><f:input type ="text" path="numTel" class="form-control"/></td>
				<td><f:errors path="numTel"></f:errors></td>
			</tr>
			<tr>
				<td>Numéro fax :</td>
				<td><f:input type ="text" path="numFax" class="form-control"/></td>
				<td><f:errors path="numFax"></f:errors></td>
			</tr>
			<tr>
				<td>Adresse mail :</td>
				<td><f:input type ="text" path="adrMail" class="form-control"/></td>
				<td><f:errors path="adrMail"></f:errors></td>
			</tr>
			</table>
				<br>
				<td><f:input type ="submit" value="Enregistrer" path="" class="btn btn-default"/></td>
