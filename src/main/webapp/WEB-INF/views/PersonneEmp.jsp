...
<f:form modelAttribute="modelEmploye" action="validEmploye" method="POST">

		<select name="typePersonne" class="c-select">
  		<option value="0" >Sélectionner un type d'employé</option>
		<option value="1">Contractuel</option>
		...
		<table>
			...
			<tr>
				<td>Prime :</td>
				<td><f:input type ="text" path="prime" class="form-control"/></td>
				<td><f:errors path="prime"></f:errors></td>
			</tr>
			<tr>
				<td>Date de sortie :</td>
				<td><f:input type ="date" path="dateSortieService" class="form-control"/></td>
				<td><f:errors path="dateSortieService"></f:errors></td>
			</tr>
			<tr>
				<td>Date d'entrée :</td>
				<td><f:input type ="date" path="dateEntreService" class="form-control"/></td>
				<td><f:errors path="dateEntreService"></f:errors></td>
			</tr>
			<tr>
				<td>Salaire :</td>
				<td><f:input type ="text" path="salaire" class="form-control"/></td>
